...
conn = ibm_db.pconnect('DATABASE=bludb;HOSTNAME=0c77d6f2-5da9-48a9-81f8-86b520b87518.bs2io90l08kqb1od8lcg.databases.appdomain.cloud;PORT=31198;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=crb08673;PWD=uT97nw08OvG2AFHK',' ',' ')
print(conn)
...
@app.route('/')
def home():
    message = "TEAM ID : PNT2022TMID29835" +" "+ "BATCH ID : B1-1M3E "
